(function () {
    ...
    L.Control.FullScreen = L.Control.extend({
        ...
        onAdd: function (map) {
		 ...
		 className += ' fullscreen-icon';	 // use bg images version
                //className += ' k-icon k-i-fullscreen'; // use kendo UI icon
            }
        ...
        _toggleTitle: function () {
            ...
            //this.link.className = this._map._isFullscreen ? name.replace('exitfullscreen-icon', 'fullscreen-icon') : name.replace('fullscreen-icon', 'exitfullscreen-icon');
	    this.link.className = this._map._isFullscreen ? name.replace('k-i-fullscreen-exit', 'k-i-fullscreen') : name.replace('k-i-fullscreen', 'k-i-fullscreen-exit');
	},
